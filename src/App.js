  ...
  return (
    <div className="App">
      ...
      <div className="writing-main-text">
        ...
        <p>Selected Work:</p>
        <ul>
          <li><a className="links-to-articles" href="https://www.nytimes.com/interactive/2024/06/13/realestate/lincoln-center-san-juan-hill.html" target="_blank" rel="noopener noreferrer">For Lincoln Center's West Side, A New Story</a>, Published in <b style={{"color":"#5e86e6"}}>The New York Times</b>, 6/24</li>
          <p></p>
